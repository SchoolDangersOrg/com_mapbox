...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	...
	<div id="filter-bar" class="btn-toolbar">
		...
		<div class="btn-group pull-right hidden-phone">
			<label for="directionTable" class="element-invisible"><?php echo JText::_('COM_MAPBOX_LIST_ORDERING_LABEL');?></label>
		...
		<div class="btn-group pull-left">
			<input type="text" name="filter_search" id="filter-search_" class="input-large" placeholder="<?php echo JText::_('COM_MAPBOX_FILTER_SEARCH_LABEL'); ?>" value="<?php echo $this->filter->filter_search; ?>" />
		</div>
		<div class="btn-group pull-left">
		...
		<thead>
			<tr>
				...
				<th class="title" class="nowrap">
					<?php echo JHtml::_('grid.sort', 'COM_MAPBOX_MARKER_NAME_LABEL', 'marker_name', $this->filter->filter_order_Dir, $this->filter->filter_order, 'markers.filter'); ?>
				</th>
				<th class="nowrap">
				...
				<th width="1%">
					<?php echo JHtml::_('grid.sort', 'COM_MAPBOX_LIST_ID_LABEL', 'marker_id', $this->filter->filter_order_Dir, $this->filter->filter_order, 'markers.filter'); ?>
				</th>
			</tr>
		</thead>
		<tbody>
